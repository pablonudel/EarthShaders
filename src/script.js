...
const spaceTexture = textureLoader.load("./earth/8k_stars_milky_way.jpg")
spaceTexture.colorSpace = THREE.SRGBColorSpace

const flareTexture0 = textureLoader.load("./lenses/lensflare0.png")
const flareTexture1 = textureLoader.load("./lenses/lensflare1.png")
...
//Space
const spaceGeometry = new THREE.SphereGeometry(16, 64, 64)
 ...
 * Sun
 */
const sunSpherical = new THREE.Spherical(1, Math.PI * 0.5, -0.8)
...
lensFlare.addElement(new LensflareElement(flareTexture0, 512))
...
const updateSun = () => {
	...
	//Debug
	debugSun.position.copy(sunDirection).multiplyScalar(14)
	light.position.copy(sunDirection).multiplyScalar(14)
